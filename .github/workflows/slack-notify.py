...
class SecretScanSlackMessage:
    ...
    def get_section_block(self):
        ...
        for block in self.report:
            ...
            blocks.append(self._get_section_block(repo, count,owner,dojo_product_id))
    ...
    @staticmethod
    def _get_section_block(repo, count,owner,dojo_product_id):
        return {
			"type": "section",
			"fields": [
				{
				...
				{
					"type": "mrkdwn",
					"text": f"*Issue Details:* <https://defectdojo.devops.team.oozou.com/product/{dojo_product_id}|defectdojo link>"
				}
			]
	}
